...
export declare const createSortingState: <T extends TableRow>(by: keyof T, order?: OrderType, sortFn?: ((a: T[keyof T], b: T[keyof T]) => number) | undefined) => SortingState<T>;
...
export declare const transformColumns: <T extends TableRow>(columns: TableColumn<T>[], maxLevel: number) => Header<T>[][];
/**
