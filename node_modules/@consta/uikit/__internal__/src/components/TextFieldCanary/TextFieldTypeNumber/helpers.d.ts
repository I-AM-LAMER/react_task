export declare const getValueByStepArray: (steps: number[], value: string | null | undefined, isIncrement: boolean) => number;
...
export declare const stepIsActive: (step: number | string | number[], disabled?: boolean) => boolean;
