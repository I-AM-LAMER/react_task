...
export declare type TextFieldPropValue<TYPE> = TYPE extends 'textarray' ? string[] | null : string | null;
export declare type TextFieldPropDefaultValue<TYPE> = TYPE extends 'textarray' ? never : string | null;
export declare type TextFieldPropSize = FieldPropSize;
export declare type TextFieldPropOnChange<TYPE> = (value: TextFieldPropValue<TYPE>, params: {
    e: React.ChangeEvent | React.MouseEvent | React.KeyboardEvent;
}) => void;
declare type InputType<TYPE extends string> = TYPE extends 'textarea' ? HTMLTextAreaElement : HTMLInputElement;
declare type TextFieldPropsTypeTextArea<TYPE> = TYPE extends 'textarea' ? {
    resize?: boolean | 'auto';
} & ({
    minRows?: never;
    maxRows?: never;
...
export declare type TextFieldPropRenderValueItem = (props: {
    item: string;
    index: number;
...
declare type TextFieldPropsTypeTextArray<TYPE> = TYPE extends 'textarray' ? {
    renderValueItem?: TextFieldPropRenderValueItem;
    inputValue?: string | null;
    onInputChange?: TextFieldPropOnChange<string>;
} : {};
declare type TextFieldPropsTypeNumber<TYPE> = TYPE extends 'number' ? {
    max?: number | string;
    min?: number | string;
    step?: number | string | number[];
    incrementButtons?: boolean;
} : {};
export declare type TextFieldProps<TYPE extends string> = PropsWithHTMLAttributesAndRef<{
    className?: string;
...
}, HTMLDivElement> & TextFieldPropsTypeTextArea<TYPE> & TextFieldPropsTypeTextArray<TYPE> & TextFieldPropsTypeNumber<TYPE>;
export declare type TextFieldComponent = <TYPE extends string>(props: TextFieldProps<TYPE>) => React.ReactElement | null;
export declare type TextFieldTypeComponent<TYPE extends string> = (props: TextFieldProps<TYPE>) => React.ReactElement | null;
export {};
