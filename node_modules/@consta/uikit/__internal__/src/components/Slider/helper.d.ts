...
declare type SliderPropTooltipFormatter = (value: number | undefined) => string;
...
declare type GetOnChangeForInputReturned = (props: {
    e?: React.ChangeEvent | React.MouseEvent | React.KeyboardEvent;
    value: number;
}) => void;
export declare const getOnChangeForInput: (props: SliderProps<boolean>, field: 0 | 1) => GetOnChangeForInputReturned;
